Feature:
   #go to website "https://test.hypnotes.net/" # OR # User go to the homePage
  Scenario Outline: As a user, on the footer of the page I should be able to see the Explore, Features,
  Company Titles and related subtitles.
    Given go to bottom page
    Then assert titles are enable "<title>"
    Examples:titles as follow
      | title                                                                   |
      | Blog                                                                    |
      | Pricing                                                                 |
      | How It Works?                                                           |
  ...
  Scenario: US_011_TC02 The user verifies that the Headings in the relavent section should be clickable
    Given go to "https://test.hypnotes.net"
